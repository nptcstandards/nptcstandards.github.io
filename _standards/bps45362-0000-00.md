---
layout: standard
title: Geographic information. Preservation of digital data and metadata. Fundamentals
ref_base: bps45362
ref_part:
ref_pub_date:
ref_full: bps45362-0000-00
alt_refs:
- org: &org_DII
...
- org: &org_ISO
  ...
  ref: 19165
permalink: bps45362-0000-00.html
...
author_org: *org_ISO
owner_org:
abstract: This can be used by anyone who wants to use a standardised way of presenting
  and sharing geographical data. It helps cut out the uncertainty and confusion when
  communicating items across borders.
usage: This gives guidance on how to appropriately store and index any geographic
  based data.
links:
- collate_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030317147#tabs-2
  sha1: 1c3dde5e2b2437db512d09752b919d558c90f09f
  mime:
  link_or_collect: c
  requires_logon:
    lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps45362-0000-00-geographic-information-preservation-of-digital-data-and-metadata-fundamentals.html
  http_response:
  mime_type: .html
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps45362-0000-00-geographic-information-preservation-of-digital-data-and-metadata-fundamentals.html
  publish_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030317147#tabs-2
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.128777
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.128777
  approvals:
  - date: 2018-10-22
    approver:
