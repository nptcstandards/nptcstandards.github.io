...
- org: &org_BSI
  ...
  ref: BS 10012
permalink: bps80736-0000-00.html
...
author_org: *org_BSI
owner_org:
abstract: "BS 10012 provides a best practice framework for a personal information\
  \ management system that is aligned to the principles of the EU GDPR. It outlines\
  \ the core requirements organisations need to consider when collecting, storing,\
  \ processing, retaining or disposing of personal records related to individuals.\
  \ Easily integrated with other popular management system standards, BS 10012 brings\
  \ big benefits to companies of all sizes, including:\nHelps to identify and manage\
  \ risks to personal information \nSupports regulatory compliance with data protection\
  \ legislation \nInspires customer trust  \nProtects your organizations reputation\
  \ \nBenchmarks your own personal information management practices with recognized\
  \ best practice"
usage: This is relevant to everybody handling personal data and gives guidance on
  how to be GDPR compliant amongst other areas.
links:
- collate_url: https://www.bsigroup.com/en-GB/BS-10012-Personal-information-management
  sha1: 01c72a406c31f8a05304df6e6e07bb21e2d11ce5
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/British Standards Institute/bps80736-0000-00-data-protection-specification-for-a-personal-information-management-system.html
  http_response:
  mime_type: .html
  publish_url: https://www.bsigroup.com/en-GB/BS-10012-Personal-information-management
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.239829
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.239829
  approvals:
  - date: 2018-10-22
    approver:
