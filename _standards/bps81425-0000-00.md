---
layout: standard
title: FSR Code of Practice and Conduct
ref_base: bps81425
ref_part:
ref_pub_date:
ref_full: bps81425-0000-00
alt_refs:
- org: &org_DII
...
- org: &org_FSREG
    ...
    created:
    disolved:
    url: https://www.gov.uk/government/organisations/forensic-science-regulator
  ref: '-'
permalink: bps81425-0000-00.html
...
access_group:
  value: Open
sponsor_org:
author_org: *org_FSREG
owner_org:
abstract: When the provisions in the Codes are fully implemented by all forensic science
  providers and practitioners and are understood by all end users, the potential for
  a forensic science quality failure to cause a miscarriage of justice will be substantially
  reduced. This is of course why, despite the challenging financial environment, the
  requirement to comply is so crucially important. The Codes are intended to assist
  organisations with understanding and interpreting the requirements of the standards,
  particularly BS/EN ISO/IEC 17025. Later this year, there will be a more in-depth
  review of the Codes, to ensure the requirements of BS/EN ISO/IEC 17020 and ILAC
  G19:08/2014 are fully reflected.
usage: The Forensic Science Regulators Code of Practice and Conduct are intended to
  assist all relevant organisations with understanding and interpreting the requirements
  of ISO 17025, which covers all areas of forensic examinations to enable them to
  be used as evidence.
links:
- collate_url: file://{DII-open-access}/DII S&R 040 - FSR Code of Practice and Conduct.pdf
  sha1: 42995cb21f3df9dbfb77be5df3b102945be1f38d
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/Forensic Science Regulator/bps81425-0000-00-fsr-code-of-practice-and-conduct.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps81425/bps81425-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.780777
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.780777
  approvals:
  - date: 2018-10-22
    approver:
