...
ref_part:
ref_pub_date:
ref_full: bps64013-0000-00
alt_refs:
permalink: bps64013-0000-00.html
...
owner_org: *org_ISO
abstract: "Provides guidance on the integrated implementation of ISO/IEC 27001 and\
  \ ISO/IEC 20000‑1 for those organizations that are intending to either\na) implement\
  \ ISO/IEC 27001 when ISO/IEC 20000‑1 is already implemented, or vice versa,\nb)\
  \ implement both ISO/IEC 27001 and ISO/IEC 20000‑1 together, or\nc) integrate existing\
  \ management systems based on ISO/IEC 27001 and ISO/IEC 20000‑1.\nISO/IEC 27013-2015\
  ...
  \ system (SMS) as specified in ISO/IEC 20000‑1.\nIn practice, ISO/IEC 27001 and\
  \ ISO/IEC 20000‑1 can also be integrated with other management system standards,\
  \ such as ISO 9001 and ISO 14001."
usage:
links:
- collate_url: https://www.iso.org/standard/64138.html
  sha1: 70520c8185349b4dfb6e9cf4aa945f1577b8a666
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps64013-0000-00-guidance-on-the-integrated-implementation-of-iso-iec-27001-and-iso-iec-20000-1.html
  http_response:
  mime_type: .html
  publish_url: https://www.iso.org/standard/64138.html
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.066340
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.066340
  approvals:
  - date:
    approver:
    approval_org:
