---
layout: standard
title: Multimedia framework (MPEG-21)
ref_base: bps24576
ref_part:
ref_pub_date:
ref_full: bps24576-0000-00
alt_refs:
- org: &org_DII
...
- org: &org_ISO
  ...
  ref: 21000
permalink: bps24576-0000-00.html
...
author_org: *org_ISO
owner_org:
abstract: 'The MPEG-21 Multimedia Framework is based on two essential concepts: the
  definition of a fundamental unit of distribution and transaction (the Digital Item)
  and the concept of Users interacting with Digital Items. The Digital Items can be
  considered the "what" of the Multimedia Framework (e.g. a video collection, a music
  album) and the Users can be considered the "who" of the Multimedia Framework. This
  is intended to support transactions that are interoperable and highly automated,
  which are required to support these new types of commerce. Thus, the new MPEG-21
  tools enable new techniques for the creation, collection, packaging and distribution
  of content.'
usage: This gives guidance on the management of multimedia items (MPEGS).
links:
- collate_url: https://shop.bsigroup.com/SearchResults/?q=21000
  sha1: a091751d56ed27ccc95f4a7209960ef5ed31baa5
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps24576-0000-00-multimedia-framework-mpeg-21.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/SearchResults/?q=21000
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.667564
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.667564
  approvals:
  - date: 2018-10-22
    approver:
