...
ref_part:
ref_pub_date:
ref_full: bps04196-0000-00
alt_refs:
permalink: bps04196-0000-00.html
security_classification: OFFICIAL
access_group:
  value: Open
sponsor_org:
author_org: &org_DublinCore
...
owner_org: *org_DublinCore
abstract: Dublin Core Metadata Initiative develops and maintains specifications in
  support of resource description.
usage:
links:
- collate_url: http://dublincore.org/specifications/
  sha1: 1d3d273ebf76544c4ef281d252c9dfcf674068d6
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{library_location}/Open Access/Dublin Core Metadata Initiative/bps04196-0000-00-dublin-core-metadata-initiative.html
  http_response:
  mime_type: .html
  publish_url: /library/bps04196/bps04196-0000-00.html
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.593367
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.593367
  approvals:
  - date:
    approver:
    approval_org:
