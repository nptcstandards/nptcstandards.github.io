...
- collate_url: file://{DII-open-access}/DII S&R 048 - Guidance on application of ISO
  ...
  link_or_collect: c
  requires_logon:
  lib_url: file://{library_location}/Open Access/United Kingdom Accreditation Service/bps96514-0000-00-guidance-on-the-application-of-iso-17025-dealing-with-expressions-of-opinions-and-interpretations.pdf
  http_response:
  mime_type: .pdf
