...
ref_part:
ref_pub_date:
ref_full: bps39576-0000-00
alt_refs:
permalink: bps39576-0000-00.html
...
author_org: &org_HMG
  ...
  url:
owner_org: *org_HMG
abstract: "The ACPO Community Security Policy sets out the following sources of Information\
  \ Security Policy and Guidance. These are-\n\n    HMG Security Policy Framework\n\
  \    ACPO and PIAB policies\n    HMG Information Assurance Standards (Not all publicly\
  \ available)\n    CESG Good Practice Guides (Not publicly available)\n    CESG IA\
  \ notices (Not all publicly available)\n    ISO/IEC27001 – though there are now\
  \ many other documents in the 27000 range"
usage:
links:
- collate_url: http://library.college.police.uk/docs/APP-Community-Security-Policy-2014.pdf
  sha1: 3ffee4e0656d0ea206eee6de35d59656d230e86f
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/HM Government/bps39576-0000-00-security-techniques-guidance-for-code-of-practice-for-security-controls.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps39576/bps39576-0000-00.pdf
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.121284
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.121284
  approvals:
  - date:
    approver:
    approval_org:
