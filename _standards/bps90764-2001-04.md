---
layout: standard
title: Guide to quality control and performance improvement using qualitative (attribute)
  data.
ref_base: bps90764
ref_part:
ref_pub_date: 2001-04
ref_full: bps90764-2001-04
alt_refs:
- org: &org_DII
...
- org: &org_BSI
  ...
  ref: '5701 : 01'
permalink: bps90764-2001-04.html
...
author_org: *org_BSI
owner_org:
abstract: This standard describes the usage of attributed charts within public organisations
  to improve quality and performance of both people and processes.
usage: The analytical guides are relevant to multiple areas in DII, wherever data
  ...
  guide on using data in performance improvement
links:
- collate_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030016256
  sha1: f221712a3a58d4a662f8e6e8408de71265a29d3a
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/British Standards Institute/bps90764-2001-04-guide-to-quality-control-and-performance-improvement-using-qualitative-attribute-data.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030016256
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.287016
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.287016
  approvals:
  - date: 2018-10-22
    approver:
