...
ref_part:
ref_pub_date:
ref_full: bps68059-0000-00
alt_refs:
permalink: bps68059-0000-00.html
...
owner_org: *org_W3C
abstract: "RDF is a standard model for data interchange on the Web. RDF has features\
  ...
  \ referred to as a “triple”). Using this simple model, it allows structured and\
...
usage:
links:
- collate_url: https://www.w3.org/standards/techs/rdf#w3c_all
  sha1: e9f2cd437338c91ddee7af25b63fd7aceff20cea
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/World Wide Web Consortium/bps68059-0000-00-resource-description-framework-rdf.html
  http_response:
  mime_type: .html
  publish_url: https://www.w3.org/standards/techs/rdf#w3c_all
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.424185
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.424185
  approvals:
  - date:
    approver:
    approval_org:
