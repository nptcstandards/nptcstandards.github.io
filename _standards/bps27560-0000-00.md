...
ref_part:
ref_pub_date:
ref_full: bps27560-0000-00
alt_refs:
permalink: bps27560-0000-00.html
...
abstract: The National Policing Improvement Agency (NPIA) developed the Police Corporate
  Data Model (CorDM) and associated Corporate XML (CorXML), which were key components
  of its Information Systems Strategy for the Police Service (ISS4PS) and Information
  Systems Improvement Strategy (ISIS) programmes.  CorDM and CorXML became obsolete
  on the closure of the NPIA and the websites were removed.
usage:
links:
- collate_url: https://www.listpoint.co.uk/Context/details/CorDM/7.3
  sha1: e7beca33bd40b969644e5fbf0d6e12dd1ed653a1
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/Listpoint/bps27560-0000-00-cordm-v7-3.html
  http_response:
  mime_type: .html
  publish_url: https://www.listpoint.co.uk/Context/details/CorDM/7.3
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.445423
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.445423
  approvals:
  - date:
    approver:
    approval_org:
