---
layout: standard
title: APP on Intelligence Management - Analysis
ref_base: bps98012
ref_part:
ref_pub_date:
ref_full: bps98012-0000-00
alt_refs:
- org: &org_DII
    ...
    url: https://www.npcc.police.uk/NPCCBusinessAreas/ReformandTransformation/Digitalpolicing.aspx
  ref: DII S&R 002
permalink: bps98012-0000-00.html
...
owner_org:
abstract: These guidelines describe how the analysis of intelligence products can
  be conducted, and includes areas such as presentation of intelligence, prioritisation
  methods, basic analytical methods and external references.
usage: This is relevant to all areas of analysis and intelligence and gives ways to
  analyse and enrich information.
links:
- collate_url: file://{DII-open-access}/DII S&R 002 - Intelligence Management Analysis.pdf
  sha1: 7713693ffb152dedfe89714eb39d2e25ec38eef2
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/College of Policing/bps98012-0000-00-app-on-intelligence-management-analysis.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps98012/bps98012-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:20.922465
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:20.922465
  approvals:
  - date: 2018-10-22
    approver:
