---
layout: standard
title: End user device - security principles (NCSC)
ref_base: bps03698
ref_part:
ref_pub_date:
ref_full: bps03698-0000-00
alt_refs:
permalink: bps03698-0000-00.html
...
- collate_url: https://www.ncsc.gov.uk/guidance/end-user-devices-security-principles
  ...
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps03698-0000-00-end-user-device-security-principles-ncsc.html
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:13.893036
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:13.893036
  approvals:
  - date:
    approver:
    approval_org:
