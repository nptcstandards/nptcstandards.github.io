...
ref_part:
ref_pub_date:
ref_full: bps98201-0000-00
alt_refs:
permalink: bps98201-0000-00.html
...
author_org:
owner_org:
abstract: "Your service must be accessible to everyone who needs it. If it isn’t,\
  \ you may be in breach of the Equality Act 2010.\nThis means you need to start thinking\
  \ about how users might access and use your service before you design or build anything.\n\
  Accessibility isn’t the responsibility of just one person. Everyone on your team\
  \ is responsible for making sure your service is accessible."
usage:
links:
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:14.410214
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:14.410214
  approvals:
  - date:
    approver:
    approval_org:
