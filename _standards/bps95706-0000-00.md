---
layout: standard
title: Legal Obligations (Issue 5)
ref_base: bps95706
ref_part:
ref_pub_date:
ref_full: bps95706-0000-00
alt_refs:
- org: &org_DII
...
- org: &org_FSREG
  ...
  ref: FSR-I-400
permalink: bps95706-0000-00.html
...
owner_org:
abstract: "This guidance from the Forensic Science Regulator provides details of the\
  \ obligations placed on expert witnesses in the criminal justice system in England\
  \ and Wales, and is seen as core reading for all those whose work may contribute\
  \ at some point to expert evidence in a court. It is recommended to be applied alongside\
  \ the FSR Code of Practice and Conduct. It provides information on the requirements\
  \ imposed by:\nthe statute\ncase law\ncriminal procedure rules\ncriminal practice\
  \ directions"
usage: This guidance supplements ISO 17025 and is from the Forensic Science Regulator
  to assist with anyone whose work may contribute at some point to being expert evidence
  in court.
links:
- collate_url: file://{DII-open-access}/DII S&R 041 - FSR I 400 Legal Obligations.pdf
  sha1: ea9199a2e6079a0afb3ab1604b7c50af2e73b2fa
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/Forensic Science Regulator/bps95706-0000-00-legal-obligations-issue-5.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps95706/bps95706-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.803187
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.803187
  approvals:
  - date: 2018-10-22
    approver:
