---
layout: standard
title: Information technology – Security techniques – Code of practice for information
  security management.
ref_base: bps53076
ref_part:
ref_pub_date: 2017-03
ref_full: bps53076-2017-03
alt_refs:
- org: &org_DII
...
- org: &org_ISO
  ...
  ref: 27002
permalink: bps53076-2017-03.html
...
author_org: *org_ISO
owner_org:
abstract: "As part of the FSR code of conduct it states that organisations must establish\
  \ and document a policy and procedure for the management of electronic information\
  \ based on business and security requirements and include this in the schedule of\
  \ regular audit and review. This guidance gives guidelines for organizational information\
  \ security standards and information security management practices including the\
  \ selection, implementation and management of controls taking into consideration\
  \ the organization's information security risk environment(s).\n\nIt is designed\
  \ to be used by organizations that intend to:\nselect controls within the process\
  \ of implementing an Information Security Management System based on ISO/IEC 27001;\n\
  implement commonly accepted information security controls;\ndevelop their own information\
  \ security management guidelines."
usage: This document supplements ISO 27001, and is referenced in the FSR code of conduct.
  It gives the code of practice around managing information security within an organisation.
links:
- collate_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030347481
  sha1: dfbc26b389d07e7d6803acbc882dadd6f9a8a83c
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps53076-2017-03-information-technology-security-techniques-code-of-practice-for-information-security-management.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030347481
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.935810
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.935810
  approvals:
  - date: 2018-10-22
    approver:
