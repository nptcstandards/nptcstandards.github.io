---
layout: standard
title: Quality Management Systems - Guidelines for performance improvement
ref_base: bps16397
ref_part:
ref_pub_date: 2018-04
ref_full: bps16397-2018-04
alt_refs:
- org: &org_DII
...
- org: &org_ISO
  ...
  ref: 9004
permalink: bps16397-2018-04.html
...
author_org: *org_ISO
owner_org:
abstract: This standard gives guidelines for enhancing an organisation's ability to
  achieve sustained success and is consistent with the quality management principles
  given in ISO 9000:2015. It provides a self-assessment tool to review the extent
  to which the organisation has adopted the concepts in this document and is applicable
  to any organisation, regardless of its size, type and activity.
usage: This gives guidance on how to use quality management systems to improve performance.
links:
- collate_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030348166
  sha1: 892c19ed389316d0a689e79e9b6b678dba10833b
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps16397-2018-04-quality-management-systems-guidelines-for-performance-improvement.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030348166
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.621717
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.621717
  approvals:
  - date: 2018-10-22
    approver:
