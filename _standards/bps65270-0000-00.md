---
layout: standard
title: 'Manual of Guidance: The Freedom of Information Act v6'
ref_base: bps65270
ref_part:
ref_pub_date:
ref_full: bps65270-0000-00
alt_refs:
- org: &org_DII
    ...
    url: https://www.npcc.police.uk/NPCCBusinessAreas/ReformandTransformation/Digitalpolicing.aspx
  ref: DII S&R 006
permalink: bps65270-0000-00.html
...
author_org:
  ...
  url:
owner_org:
abstract: This is key guidance produced by ACPO to enable Forces to handle any requests
  relating to the Freedom of Information Act (V6)
usage: Applicable to everyone who stores / manages personal data and data which is
  relevant under the Freedom of Information Act. This manual gives guidance on the
  appropriate procedure to follow when receiving requests for information.
links:
- collate_url: file://{DII-open-access}/DII S&R 006 - ACPO Manual of Guidance - Freedom
    of information.pdf
  sha1: 9bf819479ab4a9194e94ba640557f0ee71e32ca3
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/Association of Chief Police Officers/bps65270-0000-00-manual-of-guidance-the-freedom-of-information-act-v6.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps65270/bps65270-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.011438
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.011438
  approvals:
  - date: 2018-10-22
    approver:
