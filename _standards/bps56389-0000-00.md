---
layout: standard
title: Retrieval of Video Evidence and Production of Working Copies from Digital CCTV
  Systems v2.0
ref_base: bps56389
ref_part:
ref_pub_date:
ref_full: bps56389-0000-00
alt_refs:
- org: &org_DII
    ...
    url: https://www.npcc.police.uk/NPCCBusinessAreas/ReformandTransformation/Digitalpolicing.aspx
  ref: DII S&R 007
permalink: bps56389-0000-00.html
...
owner_org:
abstract: This guide, produced by the Home Office in collaboration with ACPO, provides
  best practice guidance on the most appropriate ways to capture information from
  CCTV footage and then how to store and share the data with relevant bodies.
usage: This gives guidance on the best ways to capture, store and share CCTV footage.
links:
- collate_url: file://{DII-open-access}/DII S&R 007 - Retrieval of Video Evidence
    from CCTV.pdf
  sha1: 064e4f28009e3966b9758ab580a9a2822a9d3b27
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/Home Office/bps56389-0000-00-retrieval-of-video-evidence-and-production-of-working-copies-from-digital-cctv-systems-v2-0.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps56389/bps56389-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.033312
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.033312
  approvals:
  - date: 2018-10-22
    approver:
