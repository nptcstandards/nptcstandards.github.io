...
ref_part:
ref_pub_date:
ref_full: bps62784-0000-00
alt_refs:
permalink: bps62784-0000-00.html
...
abstract: A subset of the Enumerated Data Types used in the Met Police NSPIS Custody
  system as at 04 Apr 07
usage:
links:
- collate_url: https://www.listpoint.co.uk/Context/details/MP Custody/1.0
  sha1:
  mime:
  link_or_collect: c
  requires_logon: n
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.456282
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.456282
  approvals:
  - date:
    approver:
    approval_org:
