---
layout: standard
title: Asset Disposal and Information Security Alliance (ADISA)
ref_base: bps89216
ref_part:
ref_pub_date: 2017-01
ref_full: bps89216-2017-01
alt_refs:
permalink: bps89216-2017-01.html
security_classification:
access_group:
  value: Open
sponsor_org:
author_org: &org_ADISA
  name: Asset Disposal and Information Security Alliance
  org_type:
  parent_org:
  created:
  disolved:
  url: https://adisa.global/
owner_org: *org_ADISA
abstract: Certification body using an industry-specific standard to enable companies
  to demonstrate a level of competence in this discipline.
usage:
links:
- collate_url: https://adisa.global/download-the-standard/
  sha1:
  mime:
  link_or_collect: l
  requires_logon: n
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:14.441258
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:14.441258
  approvals:
  - date:
    approver:
    approval_org:
