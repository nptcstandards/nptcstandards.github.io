---
layout: standard
title: National Occupation Standards (For Justice)
ref_base: bps01586
ref_part:
ref_pub_date:
ref_full: bps01586-0000-00
alt_refs:
- org: &org_DII
  ...
  ref: DII S&R 045
- org: &org_JSSC
    name: Skills for Justice (Justice Sector Skills Council)
    org_type:
    parent_org:
    created:
    disolved:
    url: https://www.sfjuk.com/
  ref: '-'
permalink: bps01586-0000-00.html
...
author_org: *org_JSSC
owner_org:
abstract: "As part of the FSR Code of Conduct is states that \"The competence of staff\
  \ shall be routinely reassessed at intervals to ensure that it has been maintained\
  \ and is up to date.\" and that \"The provider shall determine the appropriate competence\
  \ framework for technical roles\". It also suggests that a recommended framework\
  \ to use includes this National Occupational Standards, as produced by Skills for\
  \ Justice (a registered trade mark of the Justice Sector Skills Council). \n\nhttps://www.sfjuk.com/resources/61-resources/218-nos-finder"
usage: This framework could give a basis to Digital and DII skills based assessments
  and to discover training needs
links:
- collate_url: https://www.sfjuk.com/about/sectors#Justice
  sha1: ae50e5ed6469b4b02651dc066a81817bc0120395
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/Skills for Justice (Justice Sector
    Skills Council)/bps01586-0000-00-national-occupation-standards-for-justice.html
  http_response:
  mime_type: .html
  publish_url: https://www.sfjuk.com/about/sectors#Justice
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.891453
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.891453
  approvals:
  - date: 2018-10-22
    approver:
