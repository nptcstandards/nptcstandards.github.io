...
ref_part:
ref_pub_date:
ref_full: bps90861-0000-00
alt_refs:
permalink: bps90861-0000-00.html
...
owner_org: *org_NCSC
abstract: These principles provide the basis for NCSC guidance on the configuration
  of specific EUDs.
usage:
links:
- collate_url: https://www.ncsc.gov.uk/guidance/end-user-devices-security-principles
  sha1: dff718b8596143a82957e9319d9b89201418ffa4
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps90861-0000-00-end-user-devices-security-principles.html
  http_response:
  mime_type: .html
  publish_url: https://www.ncsc.gov.uk/guidance/end-user-devices-security-principles
classification:
- ontology: bps
...
last_updated: 2016-09-24 00:00:00
obsoletes:
- ref:
obsoleted_by:
- ref:
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.302965
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.302965
  approvals:
  - date:
    approver:
    approval_org:
