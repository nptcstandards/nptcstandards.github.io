...
- collate_url: https://www.ncsc.gov.uk/guidance/secure-sanitisation-storage-media
  ...
  link_or_collect: c
  requires_logon: n
  lib_url: file://{library_location}/Open Access/National Cyber Security Centre/bps78231-0000-00-secure-sanitisation-of-storage-media.html
  http_response:
  mime_type: .html
  publish_url: /library/bps78231/bps78231-0000-00.html
classification:
- ontology: bps
  classification:
status:
