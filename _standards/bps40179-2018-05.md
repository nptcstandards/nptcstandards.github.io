---
layout: standard
title: Generic Application Development Guidance
ref_base: bps40179
ref_part:
ref_pub_date: 2018-05
ref_full: bps40179-2018-05
alt_refs:
permalink: bps40179-2018-05.html
...
owner_org: *org_NCSC
abstract: Recommendations for the secure development, procurement and deployment of
  generic applications.
usage: This guidance provides advice on how to minimise the loss of data from applications
  running on devices handling sensitive data. It is primarily for risk assessors and
  application developers, and contains recommendations for the secure development,
  procurement and deployment of generic applications.
links:
- collate_url: https://www.ncsc.gov.uk/guidance/generic-application-development-guidance
  sha1: dff718b8596143a82957e9319d9b89201418ffa4
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps40179-2018-05-generic-application-development-guidance.html
  http_response:
  mime_type: .html
  publish_url: https://www.ncsc.gov.uk/guidance/generic-application-development-guidance
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.719926
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.719926
  approvals:
  - date:
    approver:
    approval_org:
