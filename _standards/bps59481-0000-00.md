...
ref_part:
ref_pub_date:
ref_full: bps59481-0000-00
alt_refs:
permalink: bps59481-0000-00.html
...
owner_org: *org_NCSC
abstract: Guidance on how organisations can protect themselves in cyberspace, including
  the 10 steps to cyber security.
usage:
links:
- collate_url: https://www.ncsc.gov.uk/guidance/10-steps-cyber-security
  sha1: dff718b8596143a82957e9319d9b89201418ffa4
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps59481-0000-00-10-steps-to-cyber-security.html
  http_response:
  mime_type: .html
  publish_url: https://www.ncsc.gov.uk/guidance/10-steps-cyber-security
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.920543
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.920543
  approvals:
  - date:
    approver:
    approval_org:
