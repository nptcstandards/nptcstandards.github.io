...
ref_base: bps09524
ref_part:
ref_pub_date: 2016-05
ref_full: bps09524-2016-05
alt_refs:
- org: &org_DII
...
- org: &org_ISO
  ...
  ref: 15489
permalink: bps09524-2016-05.html
...
author_org: *org_ISO
owner_org:
abstract: "This part of ISO 15489 describes concepts and principles relating to the\
  \ following:\na) records, metadata for records and records systems;\nb) policies,\
  \ assigned responsibilities, monitoring and training supporting the effective management\
  \ of records;\nc) recurrent analysis of business context and the identification\
  \ of records requirements;\nd) records controls;\ne) processes for creating, capturing\
  \ and managing records."
usage: This ISO guidance defines the approach to creating, capturing and managing
  records over time regardless of their structure or form, and in all types of business
  and technological environments.
links:
- collate_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030298891
  sha1: e9fdb61a091ffddc6f33930bb9357beb38eb9f5d
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps09524-2016-05-records-management-standard.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030298891
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.467512
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.467512
  approvals:
  - date: 2018-10-22
    approver:
