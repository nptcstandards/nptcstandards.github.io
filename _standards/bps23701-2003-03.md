---
layout: standard
title: Guide to Data Analysis and Quality Control Using Custom Techniques.
ref_base: bps23701
ref_part:
ref_pub_date: 2003-03
ref_full: bps23701-2003-03
alt_refs:
- org: &org_DII
...
- org: &org_BSI
  ...
  ref: BS 5703
permalink: bps23701-2003-03.html
...
author_org: *org_BSI
owner_org:
abstract: "Areas covered within this standard are:\n1: Use in business, industry and\
  \ public service organisations\n2: Decision making techniques\n3: Use in quality\
  \ / performance improvement\n4: Use with discrete or classified data"
usage: The analytical guides are relevant to multiple areas in DII, wherever data
  ...
  guide on using different statistical data techniques in performance improvement
links:
- collate_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030054380
  sha1: 3fb897854c44c5225aea81675a16bc3bdb8ff483
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/British Standards Institute/bps23701-2003-03-guide-to-data-analysis-and-quality-control-using-custom-techniques.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030054380
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.308543
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.308543
  approvals:
  - date: 2018-10-22
    approver:
