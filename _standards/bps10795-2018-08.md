...
ref_base: bps10795
ref_part:
ref_pub_date: 2018-08
ref_full: bps10795-2018-08
alt_refs:
permalink: bps10795-2018-08.html
...
author_org:
owner_org:
abstract: You must test and audit your service to make sure it can be used by everyone
  who needs it. If it isn’t accessible, you may be in breach of the Equality Act 2010.
usage:
links:
- collate_url: https://www.gov.uk/service-manual/technology/testing-for-accessibility
  sha1: cc0cbb7f4ce86610251073554acd68a5412d0ca5
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/Misc/bps10795-2018-08-testing-for-accessibility.html
  http_response:
  mime_type: .html
  publish_url: https://www.gov.uk/service-manual/technology/testing-for-accessibility
classification:
- ontology: bps
...
subject_group:
published_date: 2017-10-01 00:00:00
last_updated:
obsoletes:
- ref:
obsoleted_by:
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.644996
  process_title: y
  add_to_library: y
  blog: n
  last_processed: 2018-08-07 15:11:12.644996
  approvals:
  - date:
    approver:
    approval_org:
