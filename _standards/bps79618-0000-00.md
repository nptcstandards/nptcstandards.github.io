...
ref_part:
ref_pub_date:
ref_full: bps79618-0000-00
alt_refs:
permalink: bps79618-0000-00.html
...
author_org: &org_ACPO
  ...
  url:
owner_org: *org_ACPO
abstract: "The National Intelligence Model (NIM) is a well established and recognised\
  \ model within policing that managers use for-\n\n    Setting strategic direction\n\
  \    Making prioritised and defendable resourcing decisions\n    Allocating resources\
  \ intelligently\n    Formulating tactical plans and tasking and co ordinating resulting\
  \ activity\n    Managing the associated risks"
usage:
links:
- collate_url: https://s3-eu-west-1.amazonaws.com/media-ict-police/uploads/2015/03/National-Intelligence-Model-Standard.doc
  sha1:
  mime:
  link_or_collect: c
  requires_logon: n
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.723147
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.723147
  approvals:
  - date:
    approver:
    approval_org:
