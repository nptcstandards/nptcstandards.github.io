...
ref_part:
ref_pub_date:
ref_full: bps49381-0000-00
alt_refs:
permalink: bps49381-0000-00.html
...
owner_org: *org_BSI
abstract: "In today’s corporate environment, organisations tend to combine a number\
  \ of management systems, such as quality, environmental and information security.\
  \ As a result, many organizations now want to harmonize these systems and where\
  \ possible, combine the auditing process for each of these.\nThe cost of failing\
  \ a management systems audit takes many forms. You could face losing valuable contracts,\
  \ prized certifications or even experience a decline in operational efficiency.\
  \ That’s why basing your audits on the principles and guidance provided in the revised\
  \ international standard BS EN ISO 19011-2011 makes sound business sense."
usage:
links:
- collate_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030257143
  sha1: cb35393c3a53fa213a93d0fc1352320e98ec69a7
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/British Standards Institute/bps49381-0000-00-audit-requirements.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/ProductDetail/?pid=000000000030257143
classification:
- ontology: bps
  classification: security.policy.audit
status:
  value: Review Status
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.160742
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.160742
  approvals:
  - date:
    approver:
    approval_org:
