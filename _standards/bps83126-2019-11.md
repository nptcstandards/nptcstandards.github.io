...
ref_base: bps83126
ref_part:
ref_pub_date: 2019-11
ref_full: bps83126-2019-11
alt_refs:
- org: &org_DII
...
- org:
  ...
  ref: 7870
permalink: bps83126-2019-11.html
...
owner_org:
abstract: "This standard presents key elements and philosophy of the control chart\
  \ approach, and identifies a wide variety of control charts (including those related\
  \ to the Shewhart control chart, those stressing process acceptance or online process\
  \ adjustment, and specialized control charts).\n\nIt presents an overview of the\
  \ basic principles and concepts and illustrates the relationship among various control\
  \ chart approaches to aid in the selection of the most appropriate standard for\
  \ given circumstances."
usage: The analytical guides are relevant to multiple areas in DII, wherever data
  ...
  guide on the guidelines of control charting in analysis.
links:
- collate_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030344612
  sha1: 78fec44713827c28201f616dcec8c61268a4186f
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/British Standards Institute/bps83126-2019-11-control-charts-part-1-general-guidelines.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/ProductDetail?pid=000000000030344612
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.377940
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.377940
  approvals:
  - date: 2018-10-22
    approver:
