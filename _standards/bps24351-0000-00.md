...
ref_part:
ref_pub_date:
ref_full: bps24351-0000-00
alt_refs:
permalink: bps24351-0000-00.html
...
author_org: &org_HMG
  ...
  url:
owner_org: *org_HMG
abstract: The CJS Data Standards Catalogue is a collection of data standards used
  by Criminal Justice Organisations in England & Wales to support interoperability
  between their different ICT systems.
usage:
links:
- collate_url: https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/360582/cjs-data-standards-catalogue-5.0.pdf
  sha1: ce535ae70290d45cefbf4e84fb3bd49c94d07c1d
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/HM Government/bps24351-0000-00-criminal-justice-system-exchange-data-standards-catalogue.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps24351/bps24351-0000-00.pdf
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.551638
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.551638
  approvals:
  - date:
    approver:
    approval_org:
