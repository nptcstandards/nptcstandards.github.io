...
- org: &org_ISO
  ...
  ref: 19794
permalink: bps45368-0000-00.html
...
author_org: *org_ISO
owner_org:
abstract: 'This guidance explains the most appropriate way to process, present, store
  and share Biometric data. The full standard covers areas such as : Speech synthesizers,
  Pattern recognition, Biometrics, Data layout, Data, Data processing, Speech recognition,
  Speech transmission systems, Iris imaging, facial recognition, vascular imaging,
  fingerprint imaging'
usage: This gives relevant guidance around the data processing, layout and storage
  of various types of Biometric data.
links:
- collate_url: https://shop.bsigroup.com/SearchResults/?q=19794
  sha1: 29ae06aedfcc7127bc211f43ee2bd0b768da66a7
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps45368-0000-00-information-technology-biometric-data-interchange-formats.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/SearchResults/?q=19794
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.400362
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.400362
  approvals:
  - date: 2018-10-22
    approver:
