...
ref_part:
ref_pub_date:
ref_full: bps36284-0000-00
alt_refs:
permalink: bps36284-0000-00.html
...
author_org: &org_HMG
  ...
  url:
owner_org: *org_HMG
abstract: An Act to make new provision for the regulation of the processing of information
  relating to individuals, including the obtaining, holding, use or disclosure of
  such information.
usage:
links:
- collate_url: https://www.legislation.gov.uk/ukpga/1998/29/introduction
  sha1: 0419d4de87246a7d139e9e8b875c8b9af11ef5ee
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/HM Government/bps36284-0000-00-data-protection-act-1998.html
  http_response:
  mime_type: .html
  publish_url: https://www.legislation.gov.uk/ukpga/1998/29/introduction
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.386980
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.386980
  approvals:
  - date:
    approver:
    approval_org:
