---
layout: standard
title: Analytical Procedures used in auditing
ref_base: bps60142
ref_part:
ref_pub_date:
ref_full: bps60142-0000-00
alt_refs:
- org: &org_DII
...
- org: &org_IAASB
    ...
    created:
    disolved:
    url: http://www.iaasb.org
  ref: ISA (UK) 520
permalink: bps60142-0000-00.html
...
access_group:
  value: Open
sponsor_org:
author_org: *org_IAASB
owner_org:
abstract: This international audit guide gives examples of various analytical procedures
  that can be used in performing audits and so increase the integrity of findings.
usage: This document gives guidance on how to use analysis within auditing, which
  is primarily based on financial audits however the general principles can apply
  to any robust audit process.
links:
- collate_url: file://{DII-open-access}/DII S&R 025 - ISA UK 520 - Analytical Procedures
    in Auditing.pdf
  sha1: 0cc79a9dcaa47cc5c1da82bc14fefad8808ed3d1
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Auditing and Assurance
    Standards Board/bps60142-0000-00-analytical-procedures-used-in-auditing.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps60142/bps60142-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.444407
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.444407
  approvals:
  - date: 2018-10-22
    approver:
