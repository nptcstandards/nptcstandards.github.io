...
ref_part:
ref_pub_date:
ref_full: bps15792-0000-00
alt_refs:
permalink: bps15792-0000-00.html
...
owner_org: *org_NCSC
abstract: Secure configuration for devices running Windows 10 1607 “Anniversary Edition”
usage:
links:
- collate_url: https://www.ncsc.gov.uk/guidance/eud-security-guidance-windows-10-1703
  sha1: dff718b8596143a82957e9319d9b89201418ffa4
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps15792-0000-00-eud-security-guidance-windows-10.html
  http_response:
  mime_type: .html
  publish_url: https://www.ncsc.gov.uk/guidance/eud-security-guidance-windows-10-1703
classification:
- ontology: bps
  classification: technical.guidance.device
status:
  value: Review Status
  description: The standard status has not been set.
subject_group:
published_date: 2017-03-01 00:00:00
last_updated: 2017-06-03 00:00:00
obsoletes:
- ref:
obsoleted_by:
- ref:
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.292221
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.292221
  approvals:
  - date:
    approver:
    approval_org:
