...
ref_part:
ref_pub_date:
ref_full: bps67240-0000-00
alt_refs:
permalink: bps67240-0000-00.html
...
owner_org: *org_GDS
abstract: Understand government secure email policy, improve email security and pass
  a service assessment for secure cloud-based email services.
usage:
links:
- collate_url: https://www.gov.uk/government/publications/email-security-standards/domain-based-message-authentication-reporting-and-conformance-dmarc
  sha1: 518d1bb59c8e07c80285e209d7898542575a4c78
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/Government Digital Service/bps67240-0000-00-guidance-domain-based-message-authentication-reporting-and-conformance-dmarc.html
  http_response:
  mime_type: .html
  publish_url: https://www.gov.uk/government/publications/email-security-standards/domain-based-message-authentication-reporting-and-conformance-dmarc
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.970236
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.970236
  approvals:
  - date:
    approver:
    approval_org:
