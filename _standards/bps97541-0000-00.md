---
layout: standard
title: Statutory Code of Practice on the Management of Police Information (MoPI Code
  of Practice)
ref_base: bps97541
ref_part:
ref_pub_date:
ref_full: bps97541-0000-00
alt_refs:
permalink: bps97541-0000-00.html
...
sponsor_org:
author_org: &org_NCPE
  name: National Crime Prevention
  org_type:
  parent_org:
  created:
  disolved:
...
abstract: Police  forces  have  a  duty  to  obtain  and  use  a  wide  variety   of   information(including
  personal  information),  in  order  to  discharge  their   responsibilities effectively.  They
  need the support and cooperation of  the public in doing so. The purpose of this
  Code and associated guidance is  to assist the police to carry out that duty.
usage:
links:
- collate_url: http://library.college.police.uk/docs/APPref/Management-of-Police-Information.pdf
  sha1: ed5796d418bba53c081c56f13bf7ee0919daebd5
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/National Crime Prevention/bps97541-0000-00-statutory-code-of-practice-on-the-management-of-police-information-mopi-code-of-practice.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps97541/bps97541-0000-00.pdf
classification:
- ontology: bps
  classification: business.policy.data
status:
  value: Review Status
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.819531
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.819531
  approvals:
  - date:
    approver:
    approval_org:
