---
layout: standard
title: Statutory Audits of Annual and Consolidated Accounts
ref_base: bps13067
ref_part:
ref_pub_date:
ref_full: bps13067-0000-00
alt_refs:
- org: &org_DII
...
- org: &org_EU
    ...
    disolved:
    url:
  ref: Directive 2006/43/EC
permalink: bps13067-0000-00.html
...
author_org: *org_EU
owner_org:
abstract: This is based on financial audits, but the overall principles are relevant
  for all good audit practices. Regulations implementing the Audit Directive have
  been made by other government and regulatory bodies, including the Financial Services
  Authority, which has implemented certain requirements on listed companies, through
  the Disclosure and Transparency Rules.
usage: This is not based on policing data, but gives regulations around the best way
  to produce financial audits. The general principles in here may be relevant to setting
  up robust auditing processes.
links:
- collate_url: file://{DII-open-access}/DII S&R 024 - EU Directive 2006 43 EC - Audits.pdf
  sha1: a36d0f7f189476a319f62090c05b7d2265744a7f
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/European Union/bps13067-0000-00-statutory-audits-of-annual-and-consolidated-accounts.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps13067/bps13067-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.422960
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.422960
  approvals:
  - date: 2018-10-22
    approver:
