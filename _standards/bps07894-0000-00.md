---
layout: standard
title: Code of Practice for Protection of Personally Identifiable Information (PII)
  in Public Clouds acting as PII Processors
ref_base: bps07894
ref_part:
ref_pub_date:
ref_full: bps07894-0000-00
alt_refs:
permalink: bps07894-0000-00.html
...
owner_org: *org_ISO
abstract: Establishes commonly accepted control objectives, controls and guidelines
  for implementing measures to protect Personally Identifiable Information (PII) in
  accordance with the privacy principles in ISO/IEC 29100 for the public cloud computing
  environment.
usage:
links:
- collate_url: https://www.iso.org/standard/61498.html
  sha1: bbba86601dd7aecb72234b2fa11abe5409f80373
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps07894-0000-00-code-of-practice-for-protection-of-personally-identifiable-information-pii-in-public-clouds-acting-as-pii-processors.html
  http_response:
  mime_type: .html
  publish_url: https://www.iso.org/standard/61498.html
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.313363
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.313363
  approvals:
  - date:
    approver:
    approval_org:
