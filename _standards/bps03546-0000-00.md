...
ref_part:
ref_pub_date:
ref_full: bps03546-0000-00
alt_refs:
permalink: bps03546-0000-00.html
...
owner_org: *org_NCSC
abstract: Cyber Essentials Plus Certification still has the trademark simplicity of
  approach. The protections you need to have in place are the same as Cyber Essentials,
  but the verification of your cyber security is carried out independently by a Certification
  Body.
usage:
links:
- collate_url: https://www.cyberessentials.ncsc.gov.uk/getting-certified/
  sha1: f97d4c10eed382658b29435d49fc484cf8fecedf
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps03546-0000-00-cyber-essentials-plus.html
  http_response:
  mime_type: .html
  publish_url: https://www.cyberessentials.ncsc.gov.uk/getting-certified/
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.898367
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.898367
  approvals:
  - date:
    approver:
    approval_org:
