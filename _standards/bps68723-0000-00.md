...
ref_part:
ref_pub_date:
ref_full: bps68723-0000-00
alt_refs:
permalink: bps68723-0000-00.html
...
owner_org: *org_CESG
abstract: This document is a Tier Four Standard and forms part of the Security Policy
  Framework (SPF) reference [a]) and therefore it must be used by Central Government  Departments  and  Agencies.  It
  is also recommended for the wider public sector. It directly supports SPF Mandatory
  Requirements(MRs) 1,3,6, 8, 9 and 11.
usage:
links:
- collate_url: https://www.ncsc.gov.uk/content/files/guidance_files/IS1%20%26%202%20-%20Information%20Risk%20Management%20-%20issue%204.0%20April%202012%20-%20NCSC%20Web.pdf
  sha1: dff718b8596143a82957e9319d9b89201418ffa4
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/CESG/bps68723-0000-00-hmg-ia-standard-numbers-1-and-2-information-risk-management.html
  http_response:
  mime_type: .html
  publish_url: https://www.ncsc.gov.uk/content/files/guidance_files/IS1%20%26%202%20-%20Information%20Risk%20Management%20-%20issue%204.0%20April%202012%20-%20NCSC%20Web.pdf
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.200087
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.200087
  approvals:
  - date:
    approver:
    approval_org:
