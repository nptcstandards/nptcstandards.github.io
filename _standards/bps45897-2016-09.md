---
layout: standard
title: NCSC Guidelines on Storage Device Disposal
ref_base: bps45897
ref_part:
ref_pub_date: 2016-09
ref_full: bps45897-2016-09
alt_refs:
permalink: bps45897-2016-09.html
...
owner_org: *org_NCSC
abstract: Why sanitisation is necessary, the risks to manage, and how to sanitise
  affordably.
usage: This guidance is suitable for any organisation wishing to ensure that their
  data held on storage media can not be read by unauthorised parties after it has
  left organisational control.
links:
- collate_url: https://www.ncsc.gov.uk/guidance/secure-sanitisation-storage-media
  sha1: dff718b8596143a82957e9319d9b89201418ffa4
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps45897-2016-09-ncsc-guidelines-on-storage-device-disposal.html
  http_response:
  mime_type: .html
  publish_url: https://www.ncsc.gov.uk/guidance/secure-sanitisation-storage-media
classification:
- ontology: bps
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:14.420440
  process_title: y
  add_to_library: y
  blog: n
  last_processed: 2018-08-07 15:11:14.420440
  approvals:
  - date:
    approver:
    approval_org:
