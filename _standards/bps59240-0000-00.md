---
layout: standard
title: Code of Practice on the Management of Police Information
ref_base: bps59240
ref_part:
ref_pub_date:
ref_full: bps59240-0000-00
alt_refs:
- org: &org_DII
    ...
    url: https://www.npcc.police.uk/NPCCBusinessAreas/ReformandTransformation/Digitalpolicing.aspx
  ref: DII S&R 004
permalink: bps59240-0000-00.html
...
owner_org:
abstract: The code of practice governs how data is captured in a standardised format,
  and how data should also be disposed.
usage: This gives the guidance on how all information in policing should be handled.
links:
- collate_url: file://{DII-open-access}/DII S&R 004 - Management of Police Information.pdf
  sha1: ed5796d418bba53c081c56f13bf7ee0919daebd5
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/Home Office/bps59240-0000-00-code-of-practice-on-the-management-of-police-information.pdf
  http_response:
  mime_type: .pdf
  publish_url: /library/bps59240/bps59240-0000-00.pdf
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:20.967423
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:20.967423
  approvals:
  - date: 2018-10-22
    approver:
