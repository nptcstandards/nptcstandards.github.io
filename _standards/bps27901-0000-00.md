---
layout: standard
title: End user device strategy - security framework and controls
ref_base: bps27901
ref_part:
ref_pub_date:
ref_full: bps27901-0000-00
alt_refs:
permalink: bps27901-0000-00.html
...
usage:
links:
- collate_url: https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/261980/EUD_Security.pdf
  link_or_collect: c
  http_response:
  mime_type: .pdf
  sha1: c33621611e859cdbcbe1590548286449b4531cc2
  lib_url: file://{{collate_directory}}Open Access/Misc/bps27901-0000-00-end-user-device-strategy-security-framework-and-controls.pdf
  publish_url: /library/bps27901/bps27901-0000-00.pdf
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:13.872016
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:13.872016
  approvals:
  - date:
    approver:
    approval_org:
