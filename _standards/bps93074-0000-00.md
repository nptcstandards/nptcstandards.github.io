...
ref_part:
ref_pub_date:
ref_full: bps93074-0000-00
alt_refs:
permalink: bps93074-0000-00.html
...
owner_org: *org_ISO
abstract: Provides explanation and guidance on the standard
usage:
links:
- collate_url: https://www.iso.org/standard/63417.html
  sha1: ec7dfd3a9a066ec91c003ea346b8243d41771b9c
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{library_location}/Open Access/International Standards Organisation/bps93074-0000-00-security-techniques-guidance-for-code-of-practice-for-security-controls.html
  http_response:
  mime_type: .html
  publish_url: /library/bps93074/bps93074-0000-00.html
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.246799
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.246799
  approvals:
  - date:
    approver:
    approval_org:
