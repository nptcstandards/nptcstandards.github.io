...
- org: &org_ISO
  ...
  ref: 27001
permalink: bps94781-0000-00.html
...
author_org: *org_ISO
owner_org:
abstract: "The focus of ISO 27001 is to protect the confidentiality, integrity and\
  \ availability of the information in a company. This is done by finding out what\
  \ potential problems could happen to the information (i.e., risk assessment), and\
  \ then defining what needs to be done to prevent such problems from happening (i.e.,\
  \ risk mitigation or risk treatment). Therefore, the main philosophy of ISO 27001\
  \ is based on managing risks: find out where the risks are, and then systematically\
...
usage: This gives guidance on how to appropriately protect the confidentiality, integrity
  and availability of information within any company. This standard is also referenced
  in the FSR Code of Conduct as organisations must establish and document a policy
  and procedure for the management of electronic information based on business and
  security requirements and include this in the schedule of regular audit and review.
links:
- collate_url: https://shop.bsigroup.com/SearchResults/?q=27001
  sha1: 53170fa5dc5b2d3fbdc320aa6f16f4d2536a7ad8
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps94781-0000-00-information-security-management-standard.html
  http_response:
  mime_type: .html
  publish_url: https://shop.bsigroup.com/SearchResults/?q=27001
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.533837
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.533837
  approvals:
  - date: 2018-10-22
    approver:
