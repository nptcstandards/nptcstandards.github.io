...
ref_part:
ref_pub_date:
ref_full: bps04217-0000-00
alt_refs:
permalink: bps04217-0000-00.html
...
owner_org: *org_CESG
abstract: "Implementation of Good Practice Guide 13 is a strong recommendation for\
  \ all HMG ICT Systems, and is essentially compulsory for systems that store high\
  \ impact level data.\nThe goal of a Protective Monitoring system is to ensure that\
  \ there is a level of operational insight, to ensure that organisations have an\
  \ understanding of how their IT systems are being used or abused by internal or\
  \ external agents."
usage:
links:
- collate_url: http://protectivemonitoring.com/category/protective-monitoring-controls/
  sha1: c6cd5821c024899b1978d0f9c42e1e5eda7be4af
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/CESG/bps04217-0000-00-protective-monitoring-gpg13.html
  http_response:
  mime_type: .html
  publish_url: http://protectivemonitoring.com/category/protective-monitoring-controls/
classification:
- ontology: bps
  classification: security.guidance.monitoring
status:
  value: Review Status
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.006853
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.006853
  approvals:
  - date:
    approver:
    approval_org:
