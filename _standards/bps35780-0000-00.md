...
ref_part:
ref_pub_date:
ref_full: bps35780-0000-00
alt_refs:
permalink: bps35780-0000-00.html
...
owner_org: *org_ISO
abstract: Specifies requirements to plan, establish, implement, operate, monitor,
  review, maintain and continually improve a documented management system to protect
  against, reduce the likelihood of occurrence, prepare for, respond to, and recover
  from disruptive incidents when they arise.
usage:
links:
- collate_url: https://www.iso.org/standard/50038.html
  sha1: 6d82d295ff790721070b4c532d2b5a48020b2e9c
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{library_location}/Open Access/International Standards Organisation/bps35780-0000-00-business-continuity-management-systems-requirements.html
  http_response:
  mime_type: .html
  publish_url: /library/bps35780/bps35780-0000-00.html
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.143790
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.143790
  approvals:
  - date:
    approver:
    approval_org:
