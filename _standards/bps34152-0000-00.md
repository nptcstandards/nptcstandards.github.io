...
ref_part:
ref_pub_date:
ref_full: bps34152-0000-00
alt_refs:
permalink: bps34152-0000-00.html
...
abstract: The Public Services Network (PSN) provides technical policies regarding
  the operation of its network. At the Technology Leaders Network (TLN) a set of high
  level policies were agreed that provide high level guidance and ambition for the
  way in which government networks as a whole will be managed.
usage:
links:
- collate_url: https://www.gov.uk/government/publications/government-network-policy-changes/government-network-policy-changes
  sha1: ac8673b690b1557a63d28f2d0adcb2624ee6ca9d
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/Cabinet Office/bps34152-0000-00-guidance-government-network-policy-changes.html
  http_response:
  mime_type: .html
  publish_url: https://www.gov.uk/government/publications/government-network-policy-changes/government-network-policy-changes
classification:
- ontology: bps
  classification: security.guidance.network
status:
  value: Review Status
  description: The standard status has not been set.
subject_group:
published_date: 2015-07-01 00:00:00
last_updated: 2017-03-13 00:00:00
obsoletes:
- ref:
obsoleted_by:
- ref:
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.018065
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.018065
  approvals:
  - date:
    approver:
    approval_org:
