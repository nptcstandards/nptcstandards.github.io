...
ref_part:
ref_pub_date:
ref_full: bps34576-0000-00
alt_refs:
permalink: bps34576-0000-00.html
...
author_org: &org_HMG
  ...
  url:
owner_org: *org_HMG
abstract: "The CJS in England and Wales uses a commonly agreed set of data standards\
  \ to support ICT communications between the systems used by criminal justice organisations\
  \ (CJOs). These data standards are designed specifically to support the operation\
  \ of the CJS. They are to be used with open data standards as defined in the government’s\
  \ Open Standards Principles. The government’s open standards are selected by the\
  \ Cabinet Office standards hub.\nCommon data standards are used by CJOs, their ICT\
  \ suppliers and potential suppliers wishing to bid for CJS contracts. They are also\
  \ used to support the data analytics of criminal justice information.\nThese standards\
  \ are available to the public under the Open Government Licence.\nThe selection\
  \ of the CJS data standards is made by the CJS Data Standards Forum. This is a technical\
  \ forum which has representatives from the principal CJOs."
usage:
links:
- collate_url: https://www.gov.uk/guidance/criminal-justice-system-data-standards-forum-guidance
  sha1: 189fe088be164c0abd45105b5a9a59bbddd87a1e
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/HM Government/bps34576-0000-00-criminal-justice-system-data-standards-forum-guidance.html
  http_response:
  mime_type: .html
  publish_url: https://www.gov.uk/guidance/criminal-justice-system-data-standards-forum-guidance
classification:
- ontology: bps
  classification: business.guidance.process
status:
  value: Review Status
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:11.413539
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:11.413539
  approvals:
  - date:
    approver:
    approval_org:
