...
ref_part:
ref_pub_date:
ref_full: bps21953-0000-00
alt_refs:
permalink: bps21953-0000-00.html
...
owner_org: *org_ISO
abstract: "Provides guidelines intended to assist organizations in evaluating the\
  \ information security performance and the effectiveness of an information security\
  ...
  b) the monitoring and measurement of the effectiveness of an information security\
  \ management system (ISMS) including its processes and controls;\nc) the analysis\
  \ and evaluation of the results of monitoring and measurement.\nISO/IEC 27004-2016\
  \ is applicable to all types and sizes of organizations."
usage:
links:
- collate_url: https://www.iso.org/standard/64120.html
  sha1: 07944e0c9f91bcf1a23f804891098e0859231a30
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{library_location}/Open Access/International Standards Organisation/bps21953-0000-00-information-security-management-monitoring-measurement-analysis-and-evaluation.html
  http_response:
  mime_type: .html
  publish_url: /library/bps21953/bps21953-0000-00.html
classification:
- ontology: bps
  classification: security.policy.tbd
status:
  value: Review
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.257043
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.257043
  approvals:
  - date:
    approver:
    approval_org:
