---
layout: standard
title: End user device - security collection (NCSC)
ref_base: bps89305
ref_part:
ref_pub_date:
ref_full: bps89305-0000-00
alt_refs:
permalink: bps89305-0000-00.html
...
usage:
links:
- collate_url: https://www.ncsc.gov.uk/guidance/end-user-device-security
  link_or_collect: c
  http_response:
  mime_type: .html
  sha1: dff718b8596143a82957e9319d9b89201418ffa4
  lib_url: file://{{collate_directory}}Open Access/National Cyber Security Centre/bps89305-0000-00-end-user-device-security-collection-ncsc.html
  publish_url: https://www.ncsc.gov.uk/guidance/end-user-device-security
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:13.882587
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:13.882587
  approvals:
  - date:
    approver:
    approval_org:
