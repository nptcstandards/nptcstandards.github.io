...
ref_part:
ref_pub_date:
ref_full: bps04936-0000-00
alt_refs:
permalink: bps04936-0000-00.html
...
owner_org: *org_ISO
abstract: Guidelines for organizational information security standards and information
  security management practices including the selection, implementation and management
  of controls taking into consideration the organization's information security risk
  environment(s).
usage:
links:
- collate_url: https://www.iso.org/standard/54533.html
  sha1: abf28dd402ff5934bfa0f682683ed7e581b827d4
  mime:
  link_or_collect: c
  requires_logon: n
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps04936-0000-00-security-techniques-code-of-practice-for-information-security-controls.html
  http_response:
  mime_type: .html
  publish_url: https://www.iso.org/standard/54533.html
classification:
- ontology: bps
...
- date:
meta:
  catalogued_date: 2018-08-07 15:11:12.055086
  process_title: y
  add_to_library: y
  blog: y
  last_processed: 2018-08-07 15:11:12.055086
  approvals:
  - date:
    approver:
    approval_org:
