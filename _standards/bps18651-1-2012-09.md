...
- collate_url: file://{CPS-managed-access}/50403021 (1.2) Two-Way Police XML Interface
  ...
  link_or_collect: c
  requires_logon: n
  lib_url: file://{library_location}/Managed Access/Crown Prosecution Service/bps18651-1-2012-09-two-way-interface-police-cps-pcd-xml-interface-business-process-document.pdf
  http_response:
  mime_type: .pdf
