---
layout: standard
title: Information technology -- Security techniques -- Guidelines for identification,
  collection, acquisition and preservation of digital evidence
ref_base: bps16894
ref_part:
ref_pub_date:
ref_full: bps16894-0000-00
alt_refs:
- org: &org_DII
...
- org: &org_ISO
  ...
  ref: 27037
permalink: bps16894-0000-00.html
...
author_org: *org_ISO
owner_org:
abstract: "ISO/IEC 27037:2012 gives guidance for the following devices and circumstances:\n\
  ...
  \ phones, Personal Digital Assistants (PDAs), Personal Electronic Devices (PEDs),\
  \ memory cards,\nMobile navigation systems,\nDigital still and video cameras (including\
  \ CCTV),\nStandard computer with network connections,\nNetworks based on TCP/IP\
  \ and other digital protocols, and\nDevices with similar functions as above."
usage: "This is highly relevant to DII as it provides guidelines for specific activities\
  \ in the handling of digital evidence, including the identification, collection,\
  \ acquisition and preservation of potential digital evidence that can be of evidential\
  \ value. \n\nIt provides guidance to individuals with respect to common situations\
  \ encountered throughout the digital evidence handling process and assists organizations\
  \ in their disciplinary procedures and in facilitating the exchange of potential\
  \ digital evidence between jurisdictions."
links:
- collate_url: file://{DII-open-access}/DII S&R 042 - ISO27037 – Guidelines for identification,
    collection, aquisition and preservation of digital evidence.docx
  sha1: 2e3e7ebb64aba4fde134627d9d29f1161ea053ba
  mime:
  link_or_collect: c
  requires_logon:
  lib_url: file://{{collate_directory}}Open Access/International Standards Organisation/bps16894-0000-00-information-technology-security-techniques-guidelines-for-identification-collection-acquisition-and-preservation-of-digital-evidence.docx
  http_response:
  mime_type: .docx
  publish_url: /library/bps16894/bps16894-0000-00.docx
classification:
- ontology:
  classification:
status:
...
- date:
meta:
  catalogued_date: 2018-08-21 14:46:21.825155
  process_title: y
  add_to_library: y
  blog: n
  display_inline: n
  last_processed: 2018-08-21 14:46:21.825155
  approvals:
  - date: 2018-10-22
    approver:
